    ...
    for(double i = 0.005; i<=2;i+=0.1){
        ...
        //for(int t = 6; t<=24; t*=2){
            for(int j = 0; j<timesRepeat; j++){
                runCommand(12, outputFile + "step_size.txt");
           }
        //}
    }
}
...
void runLambdaTests(){
    ...
    for(double i = 0.2; i<=2;i+=0.1){
        ...
        //for(int t = 6; t<=24; t*=2){
            for(int j = 0; j<timesRepeat; j++){
                runCommand(12, outputFile + "_lambda.txt");
           }
        //}
    }
}
...
//        for(int t = 6; t<=24; t*=2){
            for(int j = 0; j<timesRepeat; j++){
                ...
                runCommand(12, outputFile + "_sched_period.txt");
    ...
    for(double i = 0.02; i<=2; i+=0.1){
       ...
       // for(int t = 6; t<=24; t*=2){
            for(int j = 0; j<timesRepeat; j++){
                ...
                runCommand(12, outputFile + "_gamma.txt");
           }
        //}
    }
}
...
//    for(int t = 6; t<=24; t*=2){
        for(int j = 0; j<3; j++){
	    runCommand(2, outputFile + "_os.txt");
            runCommand(6, outputFile + "_os.txt");
	    runCommand(12, outputFile + "_os.txt");
        }
    //}
}
...
void runCommand(int cores, string outputfile) {
    ...
    string command = programName + " " + to_string(cores) + " output.txt >>" + outputfile;
    cout << command << endl;
    system(&command[0]);
