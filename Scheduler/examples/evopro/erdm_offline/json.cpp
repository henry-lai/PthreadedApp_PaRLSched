...

static Value DeserializeArray(std::string& str, safeStack<StackDepthType>& depth_stack);
static Value DeserializeObj(const std::string& _str, safeStack<StackDepthType>& depth_stack);

static Value DeserializeInternal(const std::string& _str, safeStack<StackDepthType>& depth_stack)
{
	Value v;
...
static size_t GetEndOfArrayOrObj(const std::string& str, safeStack<StackDepthType>& depth_stack)
{
	size_t i = 1;
	bool in_quote = false;
...
static Value DeserializeValue(std::string& str, bool* had_error, safeStack<StackDepthType>& depth_stack)
{
	Value v;
...
{
	safeStack<StackDepthType> depth_stack;
	return DeserializeInternal(str, depth_stack);
}

//////////////////////////////////////////////////////////
//		general helper functions for acquiring fields from objects
//////////////////////////////////////////////////////////

bool json::getBoolJsonField(const json::Object& jsonObj, const std::string& fieldName) {

	json::Object::ValueMap::const_iterator confDataIt;

	confDataIt = jsonObj.find(fieldName);
	if (confDataIt == jsonObj.end()) {
		throw std::runtime_error(std::string(fieldName).append(" field missing"));
	}
	return confDataIt->second.ToBool();
}

int json::getIntJsonField(const json::Object& jsonObj, const std::string& fieldName) {
	...
	return confDataIt->second.ToInt();
}

float json::getFloatJsonField(const json::Object& jsonObj, const std::string& fieldName) {
	...
	return confDataIt->second.ToFloat();
}

std::string json::getStringJsonField(const json::Object& jsonObj, const std::string& fieldName) {
	...
	return confDataIt->second.ToString();
}

json::Array json::getArrayJsonField(const json::Object& jsonObj, const std::string& fieldName) {
	...
	return confDataIt->second.ToArray();
}
