...
public:
	...
	Scheduler(const unsigned int& num_cpus, const unsigned int& num_threads, const double& step_size, const double& LAMBDA,
			...
			const bool& write_to_files_details, const double& gamma, const bool& switch_back, const bool& update_actions,
			const bool& single_thread_update, const bool& performance_reshuffling, const bool& positive_reinforcement,
			const bool& inactive_reshuffling, const bool& static_mapping);
...
private:
	...
	void reshuffle(const bool& active_threads_change, std::vector< bool >& active_threads_vec, const unsigned int& num_threads, const unsigned int& num_cpus, const unsigned int & num_active_threads);
	void reshuffle_mixed(const bool& active_threads_change, std::vector< bool >& active_threads_vec, const unsigned int& num_threads, const unsigned int& num_cpus, const unsigned int& num_active_threads, const unsigned int & thread_ind);
	...
	bool single_thread_update_;
	bool performance_reshuffling_;
	bool inactive_reshuffling_;
	bool positive_reinforcement_;
	...
	std::vector< double > performances_before_;
	std::vector< double > balanced_performances_before_;


	double cur_average_performance_;	// current average performance
	double cur_balanced_performance_;	// current balanced performance
	double cur_balanced_performance_before_;
	...
	std::vector< double > run_average_balanced_performances_;

	std::vector< unsigned int > counter_after_reshuffling_;
...
//	std::vector< std::vector < double > > run_average_balanced_performances_cpu_;
	...
	std::vector<unsigned int> cpu_schedule_before_;
	...
	bool active_threads_change_;

	unsigned int thread_to_update_before_;
	unsigned int thread_to_update_;
