...
struct Struct_OverallPerformance
{
	...
	{
		run_average_performance_[resource_ind] = run_average_performance_[resource_ind] +
				1/(pow((double)iteration,0.7)+1) * (ave_performance - run_average_performance_[resource_ind]);
	}
	void update_run_average_balanced_performance_per_main_resource(const unsigned int& resource_ind, const double ave_balanced_performance, const unsigned int& iteration)
	{
		run_average_balanced_performance_[resource_ind] = run_average_balanced_performance_[resource_ind] +
				1/(pow((double)iteration,0.7)+1) * (ave_balanced_performance - run_average_balanced_performance_[resource_ind]);
	}
...
struct Struct_PerformanceMonitoring
{
	...
	void update_run_average_performance(const double& performance, const double& step_size)
	{
		run_average_performance_ = run_average_performance_ + step_size * (performance - run_average_performance_);
	}
	void update_run_average_balanced_performance(const double& balanced_performance, const double& step_size)
	{
	...
	void update_run_average_performance_per_main_resource(const double& performance, const unsigned int& main_source, const double& step_size)
	{
	...
	void update_run_average_performance_per_child_resource(const double& performance, const unsigned int& main_source, const unsigned int& child_source, const double& step_size)
	{
